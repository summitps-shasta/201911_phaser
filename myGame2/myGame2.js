...
game_state.main.prototype = {
       ...
       preload: function() {
        game.load.image('gothamcity', 'assets/gothamcity.png');
        game.load.image('ground', 'assets/platform.png');
        game.load.image('star', 'assets/batarangproto.png');
        game.load.spritesheet('dude', 'assets/batman.png', 140, 140);
    },
    ...
    create: function() {
        ...
        game.add.sprite(0, 0, 'gothamcity');
        ...
        var ledge = this.platforms.create(500, 350, 'ground');
        ledge.body.immovable = true;
        ledge.scale.setTo(0.75);
        var ledge2 = this.platforms.create(550, 150, 'ground');
        ledge2.body.immovable = true;
        ledge2.scale.setTo(0.75);
        var ledge3 = this.platforms.create(50, 200 , 'ground');
        ...
        this.player.animations.add('left', [3, 4], true);
        this.player.animations.add('right', [1, 2], true);
