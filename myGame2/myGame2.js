...
game_state.main.prototype = {
       ...
       preload: function() {
        game.load.image('Minercraft', 'assets/Minecraft.png');
        game.load.image('ground', 'assets/platform.png');
        game.load.image('star', 'assets/firstaid.png');
        game.load.spritesheet('dude', 'assets/Herobrine.png', 160, 140);
    },
    ...
    create: function() {
        ...
        this.player.animations.add('left', [2, 5], true);
        this.player.animations.add('right', [1, 3], true);
    ...
    update: function() {
        ...
        this.player.body.setSize(100, 130, 20, 10);
